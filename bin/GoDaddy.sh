...
SuccessExec='echo $(date): Public IP updated to ${PublicIP} | mail -s "Server.josephvoss.com IP Changed" josephvoss14@gmail.com'
...
FailedExec='echo Failed with reason ${Update} | mail -s "Server.josephvoss.com is down!" josephvoss14@gmail.com'
# End settings
